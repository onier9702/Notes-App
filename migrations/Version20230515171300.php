 ...
 */
final class Version20230515171300 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE notes (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, tag_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, description VARCHAR(800) DEFAULT NULL, date_posted DATETIME NOT NULL, is_public TINYINT(1) NOT NULL, is_active TINYINT(1) NOT NULL, INDEX IDX_11BA68CA76ED395 (user_id), INDEX IDX_11BA68CBAD26311 (tag_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE notes ADD CONSTRAINT FK_11BA68CBAD26311 FOREIGN KEY (tag_id) REFERENCES tags (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE notes DROP FOREIGN KEY FK_11BA68CBAD26311');
